 ...
 * can load blosc2_grok as a native codec before Python imports this package;
...
#ifndef BLOSC2_GROK_B2ND_LAYOUT_H
#define BLOSC2_GROK_B2ND_LAYOUT_H
...
#define BLOSC2_GROK_LAYOUT_MAX_DIM BLOSC2_MAX_DIM
#else
#define BLOSC2_GROK_LAYOUT_MAX_DIM B2ND_MAX_DIM
#endif
...
struct B2ndLayout {
    int8_t ndim = 0;
    std::array<int64_t, BLOSC2_GROK_LAYOUT_MAX_DIM> shape{};
    std::array<int32_t, BLOSC2_GROK_LAYOUT_MAX_DIM> chunkshape{};
    std::array<int32_t, BLOSC2_GROK_LAYOUT_MAX_DIM> blockshape{};
    std::string dtype;
...
#endif  // BLOSC2_GROK_B2ND_LAYOUT_H
